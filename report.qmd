...
```
I am having a lot of difficulty rendering the report. I am not sure what the problem is. But, my findings were that the cost of energy has increased in every state from 2021-2023. And unfortunately, there is not a discernable relationship between the proportion that a state's renewable use has increased and the increase in price. Energy costs are increasing, despite states increasing renewable use. With further analysis, perhaps we coud determine that renewable energy sources are not actually cheaper at the level they are currently being used. 
